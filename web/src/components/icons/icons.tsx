...
import meIconSVG from "../../../public/me.svg";
import chatbotSVG from "../../../public/pridox.svg";
import { FaRobot } from "react-icons/fa";
import AddDocumentsSVG from "../../../public/AddDocuments.svg";
import UploadFileSVG from "../../../public/UploadFile.svg";
import AddSourceSVG from "../../../public/AddSource.svg";
import SearchIconSVG from "../../../public/SearchIcon.svg";
import FilterIconSVG from "../../../public/FilterIcon.svg";
import URLIconSVG from "../../../public/URLIcon.svg";
import UploadIconSVG from "../../../public/UploadIcon.svg";
import GGDriveIconSVG from "../../../public/gg-drive-small.svg";
import NotionIconSVG from "../../../public/notion.svg";
import GithubIconSVG from "../../../public/github.svg";
import JiraIconSVG from "../../../public/jiraIcon.svg";
import FolderIconSVG from "../../../public/Folder.svg";
import WebsiteIconSVG from "../../../public/Internet.svg";
import AppsIconSVG from "../../../public/Apps.svg";
import PlusIconSVG from "../../../public/PlusIcon.svg";
interface IconProps {
  size?: number;
  className?: string;
}
...
export const MeIcon = ({
  ...
  <div className={className}>
    <Image src={meIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const ChatbotIcon = ({
  ...
  <div className={className}>
    <Image src={chatbotSVG} alt="Logo" width={size} height={size} />
  </div>
);

export const AddDocumentsIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => (
  <div className={className}>
    <Image src={AddDocumentsSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const UploadFileIcon = ({
  ...
  <div className={className}>
    <Image src={UploadFileSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const AddSourceIcon = ({
  ...
  <div className={className}>
    <Image src={AddSourceSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const SearchIcon = ({
  ...
  <div className={className}>
    <Image src={SearchIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const FilterIcon = ({
  ...
  <div className={className}>
    <Image src={FilterIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const URLIcon = ({
  ...
  <div className={className}>
    <Image src={URLIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const UploadIcon = ({
  ...
  <div className={className}>
    <Image src={UploadIconSVG} alt="Logo" width={size} height={size} />
  </div>
);

export const GGDriveVectorIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => (
  <div className={className}>
    <Image src={GGDriveIconSVG} alt="Logo" width={size} height={size} />
  </div>
);

export const NotionVectorIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => (
  <div className={className}>
    <Image src={NotionIconSVG} alt="Logo" width={size} height={size} />
  </div>
);

export const JiraVectorIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => (
  <div className={className}>
    <Image src={JiraIconSVG} alt="Logo" width={size} height={size} />
  </div>
);

export const GithubVectorIcon = ({
  size = 16,
  className = defaultTailwindCSS,
}: IconProps) => (
  <div className={className}>
    <Image src={GithubIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const FolderIcon = ({
  ...
  <div className={className}>
    <Image src={FolderIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const WebsiteIcon = ({
  ...
  <div className={className}>
    <Image src={WebsiteIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const AppsIcon = ({
  ...
  <div className={className}>
    <Image src={AppsIconSVG} alt="Logo" width={size} height={size} />
  </div>
);
...
export const PlusIcon = ({
  ...
  <div className={className}>
    <Image src={PlusIconSVG} alt="Logo" width={size} height={size} />
  </div>
);

        ...
        <Formik
          ...
          onSubmit={async (values, formikHelpers) => {
            ...
            if (response.ok) {
              ...
              setPopup({
                message: isUpdate
                  ? `Error updating PridoxBot config - ${errorMsg}`
                  : `Error creating PridoxBot config - ${errorMsg}`,
                type: "error",
              });
            }
          }}
          ...
          {({ isSubmitting, values }) => (
            <Form>
              <div className="px-6 pb-6">
                ...
                <TextArrayField
                  ...
                  subtext={
                    <div>
                      ...
                      <br />
                      <br />
                      <i>NOTE</i>: you still need to add PridoxBot to the
                ...
                <SectionHeader>When should PridoxBot respond?</SectionHeader>
                ...
                <BooleanFormField
                  ...
                  label="Respond to @PridoxBot Only"
                  subtext="If set, PridoxBot will only respond when directly tagged"
                />
                <BooleanFormField
                  name="respond_to_bots"
                  label="Responds to Bot messages"
                  subtext="If not set, PridoxBot will always ignore messages from Bots"
                />
                <TextArrayField
                  name="respond_team_member_list"
                  label="Team Members Emails"
                  subtext={`If specified, PridoxBot responses will only be 
                  visible to members in this list. This is
                  useful if you want PridoxBot to operate in an
                  "assistant" mode, where it helps the team members find
                  answers, but let's them build on top of PridoxBot's response / throw 
                ...
                <BooleanFormField
                  ...
                  label="Should Pridox give a “Still need help?” button?"
                  subtext={`If specified, PridoxBot's response will include a button at the bottom 
                  ...
                  <TextArrayField
                    ...
                    subtext={
                      <div>
                        ...
                        handle. For example, &apos;Pridox Team&apos; or
                        &apos;danswer-team&apos;.
                        <br />
                        <br />
                  ...
                  <Text>
                    <ul className="list-disc mt-2 ml-4">
                      ...
                      <li>
                        ...
                        which documents PridoxBot uses as references.
                      </li>
                    </ul>
                  </Text>
                  <Text className="mt-2">
                      ...
                      <FieldArray
                        ...
                        render={(arrayHelpers: ArrayHelpers) => (
                          <div>
                            <div>
                              <SubLabel>
                                The document sets that PridoxBot should search
                                through. If left blank, PridoxBot will search
